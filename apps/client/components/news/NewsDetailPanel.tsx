    ...
    return (
        <div className="h-full flex flex-col">
            ...
            <div className="flex-1 overflow-y-auto p-4 space-y-4">
                ...
                <div className="pt-2">
                    {hasAnalysis ? (
                        <div className="relative p-4 bg-indigo-50 rounded-lg border border-indigo-200">
                        ...
                        <button
                            ...
                            className="w-full flex items-center justify-center gap-2 py-3 bg-yellow-50 hover:bg-yellow-100 border border-yellow-300 rounded-lg text-yellow-700 font-semibold transition-colors disabled:opacity-50"
                        >
                            {isAnalyzing ? (
                                <>
