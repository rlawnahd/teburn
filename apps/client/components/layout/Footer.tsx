...
const FOOTER_LINK = "block py-1.5 text-[13px] text-[var(--text-tertiary)] hover:text-[var(--text-secondary)] transition-colors";
            ...
            <div className="max-w-screen-xl mx-auto">
                <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-6">
                    ...
                    <div className="flex gap-10">
                        ...
                        <div className="space-y-1">
                            <span className="text-[13px] font-semibold text-[var(--text-secondary)]">법적 고지</span>
                            <div>
