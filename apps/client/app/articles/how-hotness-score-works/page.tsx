            ...
            <main className="max-w-2xl mx-auto px-4 py-8">
                ...
                <div className="bg-[var(--bg-primary)] border border-[var(--border-color)] p-6 space-y-6">
                    ...
                    <Section title="2. 점수 산출 요소">
                        <p>주도주 점수는 다음 5가지 핵심 지표를 기반으로 산출됩니다.</p>
                        <ul className="list-disc pl-5 space-y-3 mt-3">
                            <li>
                                <strong>거래대금 (30점 배점)</strong> — 해당 종목에 실제로 유입된 자금의 규모를 평가합니다.
                                거래대금이 클수록 시장 참여자들의 관심이 높다는 것을 의미하며,
                                1,000억 원 이상이면 만점에 가까운 점수를 부여합니다.
                                50억 원 미만의 경우 최소 점수가 배정됩니다.
                            </li>
                            <li>
                                <strong>등락률 (20점 배점)</strong> — 당일 주가 상승률을 기준으로 점수를 산정합니다.
                                상한가에 근접하는 20% 이상 상승 시 만점이 부여되며, 상승률이 높을수록
                                시장에서 강한 매수세가 유입되고 있음을 나타냅니다.
                                4% 이상 상승한 종목만 주도주 점수 산출 대상에 포함됩니다.
                            </li>
                            <li>
                                <strong>거래량 급증률 (15점 배점)</strong> — 평소 거래량 대비 당일 거래량이 얼마나 급증했는지를
                                배수로 측정합니다. 거래량이 10배 이상 급증하면 만점을 받으며,
                                평소보다 현저히 높은 거래량은 새로운 매수 주체의 진입을 시사합니다.
                            </li>
                            <li>
                                <strong>뉴스 노출 빈도 (10점 배점)</strong> — 해당 종목이 최근 뉴스에 얼마나 자주 언급되었는지를
                                측정합니다. 10건 이상의 뉴스에 노출되면 만점이며,
                                미디어 노출은 시장 참여자들의 인지도와 관심을 반영하는 중요한 지표입니다.
                            </li>
                            <li>
                                <strong>대장주 집중도 (10점 배점)</strong> — 해당 종목이 속한 테마 내에서 거래대금이
                                얼마나 집중되어 있는지를 백분율로 측정합니다.
                                테마 전체 거래대금의 50% 이상을 차지하면 만점이 부여됩니다.
                                특정 종목에 자금이 집중될수록 해당 테마의 대장주로 인정받고 있다는 뜻입니다.
                            </li>
                            <li>
                                <strong>연속성 (15점 배점)</strong> — 최근 3일간 주도주 상위권에 연속으로 등장했는지를
                                평가합니다. 3일 연속 상위권이면 만점(15점), 2일이면 10점, 1일이면 5점이 부여됩니다.
                                지속적으로 시장을 주도하는 종목일수록 높은 점수를 받습니다.
                            </li>
                        </ul>
                    </Section>
                    ...
                    <Section title="3. 등급 시스템">
                        ...
                        <ul className="list-disc pl-5 space-y-2 mt-3">
                            <li>
                                ...
                                거래대금, 상승률, 거래량, 뉴스, 테마 집중도 모든 면에서 두각을 나타내는 종목으로,
                                당일 시장을 대표하는 최상위 종목입니다.
                            </li>
                            <li>
                    ...
                    <Section title="4. 데이터 업데이트 주기">
                        <p>
                            ...
                            각 갱신 시점마다 최신 시세 데이터를 기반으로 5가지 지표를 재계산하여 점수와 등급을 업데이트합니다.
                        </p>
                        <p className="mt-2">
