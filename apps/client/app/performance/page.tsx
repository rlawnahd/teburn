    ...
    return (
        <div className="card p-4">
            ...
            <div className="grid grid-cols-3 gap-2 text-center">
                <div>
                    <div className="text-[11px] text-[var(--text-tertiary)] mb-1">D+1 평균</div>
                    <div className={`text-sm font-semibold ${d1.cls}`}>{d1.text}</div>
                </div>
                <div>
                    <div className="text-[11px] text-[var(--text-tertiary)] mb-1">D+5 평균</div>
                    <div className={`text-sm font-semibold ${d5.cls}`}>{d5.text}</div>
                </div>
                <div>
                    <div className="text-[11px] text-[var(--text-tertiary)] mb-1">D+1 승률</div>
